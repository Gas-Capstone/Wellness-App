...
type CircleTimerProps = {
  ...
  label?: string;
  duration?: number;
  // Lets small rings (e.g. dashboard widgets) use a smaller text style
  // than the default — otherwise a shrunk ring's label overflows since
  // the text size was previously fixed regardless of `size`.
